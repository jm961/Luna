...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    private final CalfLibraryAccessors laccForCalfLibraryAccessors = new CalfLibraryAccessors(owner);
    ...
    private final SquircleLibraryAccessors laccForSquircleLibraryAccessors = new SquircleLibraryAccessors(owner);
    ...
    /**
     * Group of libraries at <b>calf</b>
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public CalfLibraryAccessors getCalf() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return laccForCalfLibraryAccessors;
    }
    ...
    /**
     * Group of libraries at <b>squircle</b>
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public SquircleLibraryAccessors getSquircle() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return laccForSquircleLibraryAccessors;
    }
    ...
    public static class AndroidxGlanceLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        /**
         * Dependency provider for <b>material</b> with <b>androidx.glance:glance-material3</b> coordinates and
         * with version reference <b>glanceAppwidget</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
     ...
     */
    @Deprecated
    public static class CalfLibraryAccessors extends SubDependencyFactory {
        private final CalfFileLibraryAccessors laccForCalfFileLibraryAccessors = new CalfFileLibraryAccessors(owner);

        public CalfLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>calf.file</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public CalfFileLibraryAccessors getFile() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForCalfFileLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class CalfFileLibraryAccessors extends SubDependencyFactory {

        public CalfFileLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>picker</b> with <b>com.mohamedrejeb.calf:calf-file-picker</b> coordinates and
         * with version reference <b>calf</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        public Provider<MinimalExternalModuleDependency> getPicker() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("calf.file.picker");
        }
    ...
    public static class ComposeTestLibraryAccessors extends SubDependencyFactory {
        ...
        public Provider<MinimalExternalModuleDependency> getJunit4() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("compose.test.junit4");
        }
    ...
    public static class KoinLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>annotations</b> with <b>io.insert-koin:koin-annotations</b> coordinates and
         * with version reference <b>koinKSP</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        /**
         * Group of libraries at <b>koin.ksp</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
    ...
    public static class KoinKspLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>compiler</b> with <b>io.insert-koin:koin-ksp-compiler</b> coordinates and
         * with version reference <b>koinKSP</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
    ...
    public static class MarkdownLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>coil2</b> with <b>com.mikepenz:multiplatform-markdown-renderer-coil2</b> coordinates and
         ...
         */
        @Deprecated
        public Provider<MinimalExternalModuleDependency> getCoil2() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("markdown.coil2");
        }
     ...
     */
    @Deprecated
    public static class SquircleLibraryAccessors extends SubDependencyFactory {

        public SquircleLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>shape</b> with <b>io.github.stoyan-vuchev:squircle-shape</b> coordinates and
         ...
         */
        @Deprecated
        public Provider<MinimalExternalModuleDependency> getShape() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("squircle.shape");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>calf</b> with value <b>0.5.5</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getCalf() { return getVersion("calf"); }
        ...
        /**
         * Version alias <b>glanceAppwidget</b> with value <b>1.1.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>koinBOM</b> with value <b>4.0.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>koinKSP</b> with value <b>2.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getKoinKSP() { return getVersion("koinKSP"); }
        ...
        /**
         * Version alias <b>lifecycleVersion</b> with value <b>2.9.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>markdownRenderer</b> with value <b>0.26.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>workManager</b> with value <b>2.10.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class BundleAccessors extends BundleFactory {
         ...
         *    <li>com.mikepenz:multiplatform-markdown-renderer-m3</li>
         *    <li>com.mikepenz:multiplatform-markdown-renderer-coil2</li>
         * </ul>
         * <p>
         ...
         *    <li>io.insert-koin:koin-annotations</li>
         * </ul>
         * <p>
         * This bundle was declared in catalog libs.versions.toml
         *
    ...
    public static class AndroidxBundleAccessors extends BundleFactory {
         ...
         * <ul>
         *    <li>androidx.glance:glance</li>
         *    <li>androidx.glance:glance-appwidget</li>
         *    <li>androidx.glance:glance-material3</li>
         ...
         */
        @Deprecated
        public Provider<ExternalModuleDependencyBundle> getGlance() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
    ...
    public static class KtorBundleAccessors extends BundleFactory {
        ...
        /**
         * Dependency bundle provider for <b>ktor.core</b> which contains the following dependencies:
         * <ul>
    ...
    public static class KotlinPluginAccessors extends PluginFactory {
        private final KotlinComposePluginAccessors paccForKotlinComposePluginAccessors = new KotlinComposePluginAccessors(providers, config);
        ...
        /**
         * Group of plugins at <b>plugins.kotlin.compose</b>
         */
        public KotlinComposePluginAccessors getCompose() {
            return paccForKotlinComposePluginAccessors;
        }

    }

    public static class KotlinComposePluginAccessors extends PluginFactory {

        public KotlinComposePluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Plugin provider for <b>kotlin.compose.compiler</b> with plugin id <b>org.jetbrains.kotlin.plugin.compose</b> and
         * with version reference <b>kotlin</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getCompiler() { return createPlugin("kotlin.compose.compiler"); }
